    ...
    <div className='container'>
      ...
      <form>
        ...
        <div className='form-group'>
          ...
          className='form-control' id='comments' placeholder='Seu Comentário'/>
        </div>
        <div className='form-group'>
          <label htmlFor='genres'>Gênero</label>
          <select className='form-control' onChange={onChangeGenre}
          value={genreId}>
        ...
        <div className='form-check'>
          ...
          checked={form.status ==='ASSISTIDO'} name='status'
          id='assistido' value='ASSISTIDO'  onChange={seleciona('ASSISTIDO')} />
        ...
        <div className='form-check'>
          <input className='form-check-input' type='radio' 
          checked={form.status ==='PARA_ASSISTIR'} name='status'
          id='paraAssistir' value='PARA_ASSISTIR' onChange={seleciona('PARA_ASSISTIR')} />
          <label className='form-check-label' htmlFor='status'>
            Para assistir
          </label>
        </div>
